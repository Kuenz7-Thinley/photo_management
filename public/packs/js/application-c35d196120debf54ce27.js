...
document.addEventListener('turbolinks:load', function () {
  // ツイート
  var tweetsBtn = document.getElementById("");
  document.querySelector('[id*="js-tweet-btn"]');
  console.log(tweetsBtn);
  // tweet.addEventListener('click', (e) => {
  //   console.log('dnlkasdnsakl', e)
  // })
});
...
/******/ });
//# sourceMappingURL=application-c35d196120debf54ce27.js.map