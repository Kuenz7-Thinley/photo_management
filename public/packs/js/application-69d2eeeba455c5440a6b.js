...
function postData(url, params, auth) {
...
function requestData(_x, _x2) {
  return _requestData.apply(this, arguments);
}
function _requestData() {
  _requestData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(url, params) {
    var method,
      auth,
      resp,
      json,
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            auth = _args2.length > 3 ? _args2[3] : undefined;
            _context2.next = 4;
            return fetch(url, {
              method: method,
              headers: {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return postData(API_TWEETS, params, btn.dataset.auth);
            case 3:
...
/******/ });
//# sourceMappingURL=application-69d2eeeba455c5440a6b.js.map