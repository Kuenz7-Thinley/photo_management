...
document.addEventListener('turbolinks:load', function () {
  ...
  tweetButtons.forEach(function (btn) {
    btn.addEventListener('click', function () {
      console.log('dnlkasdnsakl', btn.dataset.id);
      console.log('dnlkasdnsakl', btn.dataset.title);
      console.log('dnlkasdnsakl', btn.dataset.url);
    });
  });
});
...
/******/ });
//# sourceMappingURL=application-12f43a8a3cdeb48a6d46.js.map